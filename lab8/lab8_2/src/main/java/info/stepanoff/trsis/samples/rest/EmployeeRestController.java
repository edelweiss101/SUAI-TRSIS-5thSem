...
public class EmployeeRestController {
    ...
    private static final String msg = "{\"op\": \"%s\", \"id\": \"%d\", \"name\": \"%s\", \"department\": \"%s\", \"position\": \"%s\"}";
    ...
    public ResponseEntity<EmployeeDTO> create(
        ...
        EmployeeDTO found_employee = employeeService.read(id);
        EmployeeDTO new_room = employeeService.create(id, name, department, position);
        kafkaProduceService.send(msg.formatted("Employee.create", id, name, department, position));
        return found_employee == null
    ...
    public ResponseEntity<?> delete(
        ...
        kafkaProduceService.send(msg.formatted("Employee.delete", id, "", "", ""));
        return deleted
